# REQUISITOS DO CARLOS VIEIRA
# FEATURES
~ [X] 1. Crie uma barra azul na parte superior da página
...
~ [X] 2. Posicione o logotipo do Facebook no canto esquerdo na barra superior
...
~ [X] 3. Adicione um formulário de autenticação no canto direito da barra superior
...
~ [X] 5. Adicione um subcontainer para agrupar o rótulo e campo "E-mail ou telefone" dentro do formulário criado na etapa 3
...
~ [X] 6. Adicione um subcontainer para agrupar o rótulo e campo "Senha" dentro do formulário criado na etapa 3
...
~ [X] 7. Adicione um subcontainer com o botão "Entrar" dentro do formulário criado na etapa 3
  ...
  * Ao clicar no botão com o id #button-login deve exibir um alert com o valor do campo "Email ou telefone"
  ...
  # REQUISITOS DO LUIZ PAULO
~ [X] 8. Crie um container abaixo da barra azul para agrupar o conteúdo principal da página
...
~ [X] 9. Crie um subcontainer para colocar o conteúdo do lado esquerdo
...
~ [X] 10. Crie um subcontainer para colocar o conteúdo do lado direito
...
~ [X] 11. Crie um campo de entrada de texto para o nome do usuário dentro do formulário criado no requisito 10
...
~ [X] 12. Crie um campo de entrada de texto para o sobrenome do usuário dentro do formulário criado no requisito 10
  Pontos importantes:
...
~ [X] 13. Crie um campo de entrada de texto para o celular ou email do usuário dentro do formulário criado no requisito 10
  Pontos importantes:
...
~ [X] 14. Crie um campo de entrada para senha do usuário dentro do formulário criado no requisito 10
...
# REQUISITOS A SEREM DISTRIBUIDOS ÀS DUPLAS!

~ [X] 15. Crie um campo de entrada para data de nascimento do usuário dentro do formulário criado no requisito 10
...
~ [X] 16. Crie um campo de entrada para gênero do usuário dentro do formulário criado no requisito 10
...
~ [X] 17. Crie um botão para finalizar o cadastro dentro do formulário criado no requisito 10
...
~ [X] 18. Validar se todos os campos foram preenchidos ao clicar no botão Cadastre-se
